...
<div class="articles view large-9 medium-8 columns content">
        ...
        <?= $this->Html->link(__('编辑文章'), ['action' => 'edit', $article->id]) ?> 
        <?= $this->Form->postLink(__('删除文章'), ['action' => 'delete', $article->id], ['confirm' => __('Are you sure you want to delete # {0}?', $article->id)]) ?> 
